  ...
  return (
    <div className="customers-orchestrator animate-fade">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .customers-orchestrator { padding: 40px; background: var(--bg-deep); min-height: 100vh; font-family: 'Inter', sans-serif; }
        ...
        .badge-glow { background: #1e40af; color: #3b82f6; padding: 6px 14px; border-radius: 100px; font-size: 12px; font-weight: 700; text-transform: uppercase; border: 1px solid rgba(59, 130, 246, 0.2); }
        ...
        .meta-stack .n { font-weight: 700; color: var(--text-primary); font-size: 15px; line-height: 1.4; }
        .meta-stack .m { font-size: 11px; color: #94a3b8; display: flex; align-items: center; gap: 4px; margin-top: 2px; }
        
        .company-pill-premium { display: flex; align-items: center; gap: 10px; background: var(--bg-elevated); padding: 6px 14px; border-radius: 10px; width: fit-content; font-size: 12px; font-weight: 700; color: #94a3b8; border: 1px solid var(--border-color); }
        ...
        .status-pill.admin { background: #991b1b; color: #fecaca; }
        .status-pill.user { background: #0369a1; color: #bfdbfe; }
        .status-pill .dot { width: 6px; height: 6px; border-radius: 50%; }
        .status-pill.admin .dot { background: #ef4444; }
        .status-pill.user .dot { background: #3b82f6; }
        
        .tier-badge-premium { font-size: 11px; font-weight: 700; color: #94a3b8; display: flex; align-items: center; gap: 4px; }
        ...
        .id-tag { font-family: 'JetBrains Mono', monospace; font-size: 11px; font-weight: 800; color: #3b82f6; background: #1e40af; padding: 6px 12px; border-radius: 8px; width: fit-content; }
        ...
        .select-box-custom { display: flex; align-items: center; gap: 15px; background: var(--bg-elevated); border: 1px solid var(--border-color); padding: 5px 20px; border-radius: 18px; transition: all 0.2s; }
        .select-box-custom:focus-within { border-color: #3b82f6; background: var(--bg-card); box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.1); }
        .select-box-custom select { border: none; background: transparent; width: 100%; padding: 15px 0; font-size: 14px; font-weight: 700; color: var(--text-primary); outline: none; }
        
        .guideline-card { display: flex; gap: 12px; background: #78350f; padding: 25px; border-radius: 24px; border: 1px solid #92400e; }
        .guideline-card svg { color: #f97316; flex-shrink: 0; }
        .guideline-card h5 { margin: 0 0 6px; font-size: 13px; color: #fed7aa; font-weight: 800; }
        .guideline-card p { margin: 0; font-size: 12px; color: #fdba74; line-height: 1.6; font-weight: 500; }

        .modal-footer-custom { padding: 40px; border-top: 1px solid var(--border-color); display: grid; gap: 12px; }
        ...
        @media (max-width: 768px) {
          .customers-orchestrator { padding: 20px; }
