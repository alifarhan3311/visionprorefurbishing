  ...
  return (
    <div className="stock-orchestrator animate-fade">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .stock-orchestrator { padding: 40px; background: var(--bg-deep); min-height: 100vh; font-family: 'Inter', sans-serif; }
        ...
        .utility-btn-premium { padding: 0 20px; border-radius: 14px; border: 1px solid var(--border-color); background: var(--bg-elevated); font-size: 13px; font-weight: 700; color: var(--text-primary); display: flex; align-items: center; gap: 8px; cursor: pointer; transition: all 0.2s; height: 46px; }
        .utility-btn-premium.active-critical { background: #7f1d1d; border-color: #ef4444; color: #fecaca; }
        ...
        .product-meta-cell .name { font-weight: 700; color: var(--text-primary); font-size: 15px; line-height: 1.4; white-space: normal; max-width: 300px; }
        ...
        .stock-count-cell .count { font-size: 20px; font-weight: 800; color: var(--text-primary); }
        ...
        .progress-bg-premium { width: 100%; height: 8px; background: var(--bg-elevated); border-radius: 10px; overflow: hidden; margin-bottom: 10px; border: 1px solid var(--border-color); }
        ...
        .status-text-pill.optimal { background: #065f46; color: #d1fae5; }
        .status-text-pill.low { background: #7f1d1d; color: #fecaca; }

        .date-pill-premium { font-size: 13px; font-weight: 700; color: #94a3b8; }

        .hub-icon-btn { width: 40px; height: 40px; border-radius: 12px; border: 1px solid var(--border-color); background: var(--bg-elevated); color: #94a3b8; display: flex; align-items: center; justify-content: center; transition: all 0.2s; cursor: pointer; }
