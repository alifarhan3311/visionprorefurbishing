  ...
  return (
    <div className="marketing-orchestrator animate-fade">
                    ...
                    <td>
                      <button 
                        ...
                        style={{
                          ...
                          gap: '6px',
                          border: 'none',
                          background: slide.isActive ? '#1e293b' : 'rgba(248, 113, 113, 0.15)',
                          color: slide.isActive ? '#dbeafe' : '#f87171',
                          padding: '6px 12px',
                          borderRadius: '8px',
                          fontSize: '12px',
                          fontWeight: '700',
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .marketing-orchestrator { padding: 40px; background: var(--bg-deep); min-height: 100vh; font-family: 'Inter', sans-serif; overflow-x: hidden; }
        ...
        .badge-glow { background: #1e40af; color: #dbeafe; padding: 6px 14px; border-radius: 100px; font-size: 12px; font-weight: 700; text-transform: uppercase; border: 1px solid rgba(99, 102, 241, 0.25); }
        ...
        .premium-form input:focus { border-color: #3b82f6; background: var(--bg-card); box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.05); }
        .form-stack { display: flex; flex-direction: column; gap: 12px; }
        
        .file-box-custom { border: 2px dashed var(--border-color); border-radius: 16px; padding: 25px; text-align: center; position: relative; transition: all 0.2s; cursor: pointer; background: var(--bg-elevated); }
        ...
        .inventory-table th { padding: 20px 40px; text-align: left; font-size: 10px; font-weight: 800; color: var(--text-primary); text-transform: uppercase; letter-spacing: 1px; background: var(--bg-elevated); white-space: nowrap; }
        ...
        .icon-box-premium { width: 44px; height: 44px; border-radius: 12px; background: var(--bg-elevated); display: flex; align-items: center; justify-content: center; color: #6366f1; border: 1px solid var(--border-color); flex-shrink: 0; }
        ...
        .status-pill-premium { font-size: 9px; font-weight: 800; text-transform: uppercase; padding: 4px 10px; border-radius: 6px; background: var(--bg-elevated); color: #94a3b8; white-space: nowrap; }
        
        .metrics-cell-premium { display: flex; flex-direction: column; }
        .metrics-cell-premium .file-type { font-weight: 800; font-size: 14px; color: var(--text-primary); }
        .metrics-cell-premium .file-size { font-size: 11px; color: #94a3b8; font-weight: 600; }

        .row-actions { display: flex; gap: 8px; justify-content: flex-end; }
        .icon-btn { width: 38px; height: 38px; border-radius: 12px; border: 1px solid var(--border-color); display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.2s; background: var(--bg-elevated); color: #94a3b8; }
