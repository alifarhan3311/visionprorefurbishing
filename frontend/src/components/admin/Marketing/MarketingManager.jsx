  ...
  return (
    <div className="marketing-orchestrator animate-fade">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .premium-form input:focus { border-color: #3b82f6; background: var(--bg-card); box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.15); }
        ...
        .file-box-custom .meta { font-size: 12px; font-weight: 700; color: #94a3b8; pointer-events: none; }
        ...
        .icon-box-premium { width: 44px; height: 44px; border-radius: 12px; background: var(--bg-elevated); display: flex; align-items: center; justify-content: center; color: #60a5fa; border: 1px solid var(--border-color); flex-shrink: 0; }
