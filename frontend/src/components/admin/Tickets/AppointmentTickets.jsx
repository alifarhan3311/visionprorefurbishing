  ...
  return (
    <div className="appointments-orchestrator animate-fade">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .appointments-orchestrator { padding: 40px; background: var(--bg-deep); min-height: 100vh; font-family: 'Inter', sans-serif; }
        ...
        .badge-glow { background: #92400e; color: #fef3c7; padding: 6px 14px; border-radius: 100px; font-size: 12px; font-weight: 700; text-transform: uppercase; border: 1px solid rgba(246, 194, 109, 0.2); }
        ...
        .id-tag-premium { font-family: 'JetBrains Mono', monospace; font-size: 11px; font-weight: 800; color: #3b82f6; background: #1e40af; padding: 4px 10px; border-radius: 6px; }
        
        .date-pill-premium { display: flex; align-items: center; gap: 12px; }
        .date-pill-premium .stack { display: flex; flex-direction: column; }
        .date-pill-premium .d { font-weight: 700; color: var(--text-primary); font-size: 14px; }
        .date-pill-premium .t { font-size: 11px; color: #94a3b8; font-weight: 600; margin-top: 2px; }
        ...
        .service-pill-premium { display: flex; align-items: center; gap: 8px; background: var(--bg-elevated); padding: 6px 14px; border-radius: 10px; width: fit-content; font-size: 12px; font-weight: 700; color: #94a3b8; border: 1px solid var(--border-color); }
        ...
        .side-modal { width: 480px; height: 100%; background: var(--bg-card); box-shadow: -20px 0 60px rgba(0,0,0,0.3); animation: slideIn 0.4s cubic-bezier(0.16, 1, 0.3, 1); display: flex; flex-direction: column; position: relative; border-left: 1px solid var(--border-color); }
        ...
        .avatar-large-premium { width: 80px; height: 80px; border-radius: 24px; background: var(--bg-elevated); color: var(--text-primary); display: flex; align-items: center; justify-content: center; font-size: 32px; font-weight: 800; margin: 0 auto 20px; border: 1px solid var(--border-color); box-shadow: 0 10px 25px rgba(0,0,0,0.3); }
        .hero h3 { font-size: 24px; font-weight: 800; margin: 0; color: var(--text-primary); }
        .hero p { color: #94a3b8; margin: 5px 0 20px; font-weight: 500; }
        ...
        .ctx-item-premium { display: flex; gap: 12px; background: var(--bg-elevated); padding: 18px; border-radius: 18px; border: 1px solid var(--border-color); }
        ...
        .ctx-item-premium .v { font-size: 14px; font-weight: 700; color: var(--text-primary); margin-top: 2px; }

        .narrative-card-premium { position: relative; background: #92400e; border: 1px solid #b45309; padding: 25px; border-radius: 24px; }
        .quote-icon { position: absolute; right: 20px; top: 20px; color: #f59e0b; opacity: 0.3; }
        .narrative-card-premium p { margin: 0; font-size: 15px; color: #fed7aa; line-height: 1.6; font-weight: 500; }

        .guideline-card { display: flex; gap: 12px; background: #1e40af; padding: 20px; border-radius: 20px; border: 1px solid #3b82f6; }
        .guideline-card svg { color: #60a5fa; flex-shrink: 0; }
        .guideline-card h5 { margin: 0 0 4px; font-size: 13px; color: #bfdbfe; font-weight: 800; }
        .guideline-card p { margin: 0; font-size: 12px; color: #93c5fd; line-height: 1.5; font-weight: 500; }

        .modal-footer-custom { padding: 40px; border-top: 1px solid var(--border-color); display: grid; gap: 12px; background: var(--bg-elevated); }
        ...
        .cancel-btn { padding: 18px; border-radius: 20px; border: 1px solid var(--border-color); font-weight: 800; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 10px; cursor: pointer; transition: all 0.2s; background: transparent; color: var(--text-primary); }
