  ...
  return (
    <div className="rma-manager animate-fade">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .rma-manager { padding: 40px; background: var(--bg-deep); min-height: 100vh; font-family: 'Inter', sans-serif; }
        ...
        .badge-glow { background: #7f1d1d; color: #fca5a5; padding: 6px 14px; border-radius: 100px; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; border: 1px solid rgba(239, 68, 68, 0.2); }
        ...
        .queue-container { background: var(--bg-card); border-radius: 32px; border: 1px solid var(--border-color); box-shadow: 0 20px 50px -12px rgba(0,0,0,0.3); overflow: hidden; }
        .queue-header { padding: 25px 35px; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center; background: var(--bg-elevated); }
        ...
        .search-box { background: var(--bg-elevated); border: 1px solid var(--border-color); padding: 8px 15px; border-radius: 12px; display: flex; align-items: center; gap: 10px; width: 280px; }
        .search-box input { border: none; outline: none; font-size: 13px; width: 100%; font-weight: 500; background: transparent; color: var(--text-primary); }
        
        .filter-btn { padding: 0 18px; border-radius: 12px; border: 1px solid var(--border-color); background: var(--bg-elevated); font-size: 13px; font-weight: 700; color: var(--text-primary); display: flex; align-items: center; gap: 8px; cursor: pointer; transition: all 0.2s; }
        ...
        .queue-table th { padding: 20px 35px; text-align: left; font-size: 10px; font-weight: 800; color: var(--text-primary); text-transform: uppercase; letter-spacing: 1px; background: var(--bg-elevated); }
        .queue-row { border-bottom: 1px solid var(--border-color); transition: all 0.2s; cursor: pointer; }
        .queue-row:hover { background: var(--bg-elevated); }
        ...
        .meta-stack .n { font-weight: 700; color: var(--text-primary); font-size: 14px; }
        .meta-stack .m { font-size: 11px; color: #94a3b8; font-weight: 500; }
        
        .reason-pill { display: flex; align-items: center; gap: 8px; background: #7f1d1d; padding: 6px 12px; border-radius: 8px; width: fit-content; font-size: 12px; font-weight: 700; color: #fca5a5; }
        ...
        .status-pill.processing { background: #1e40af; color: #bfdbfe; }
        .status-pill.completed { background: #065f46; color: #d1fae5; }
        ...
        .action-row-btn { width: 40px; height: 40px; border-radius: 12px; border: 1px solid var(--border-color); background: var(--bg-elevated); color: #94a3b8; display: flex; align-items: center; justify-content: center; transition: all 0.2s; }
        ...
        .inspector-panel { width: 500px; height: 100%; background: var(--bg-card); box-shadow: -20px 0 60px rgba(0,0,0,0.3); animation: slideIn 0.4s cubic-bezier(0.16, 1, 0.3, 1); display: flex; flex-direction: column; border-left: 1px solid var(--border-color); }
        @keyframes slideIn { from { transform: translateX(100%); } to { transform: translateX(0); } }
        
        .inspector-header { padding: 40px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-color); }
        .id-tag { font-size: 12px; font-weight: 800; color: #3b82f6; background: #1e40af; padding: 6px 12px; border-radius: 8px; }
        ...
        .op-card { background: var(--bg-elevated); padding: 20px; border-radius: 16px; border: 1px solid var(--border-color); }
        .op-row { display: flex; align-items: center; gap: 10px; margin-bottom: 10px; font-size: 13px; font-weight: 600; color: var(--text-primary); }
        .op-row:last-child { margin-bottom: 0; }
        
        .narrative-box { background: var(--bg-elevated); padding: 20px; border-radius: 20px; color: #94a3b8; font-size: 14px; line-height: 1.6; border: 1px solid var(--border-color); }
        .narrative-box.blue { background: #1e40af; color: #bfdbfe; border: 1px solid rgba(59, 130, 246, 0.3); }
        .reason-hero { display: flex; align-items: center; gap: 12px; background: #7f1d1d; color: #fca5a5; padding: 20px; border-radius: 20px; font-weight: 800; }
        .mt-3 { margin-top: 15px; }

        .inspector-footer { padding: 40px; border-top: 1px solid var(--border-color); display: grid; gap: 12px; }
        ...
        .control-btn.ghost { background: transparent; border: 1px solid var(--border-color); color: #ef4444; }
        ...
        @media (max-width: 768px) {
          ...
          .filter-btn, .add-btn { width: 100%; justify-content: center; }
